      ...
      <div class="panel panel-default card-view">
        ...
        <div class="panel-heading">
          ...
          <div class="pull-left">
            ...
            <h6 class="panel-title txt-dark ">Penambahan data pengajaran</h6>
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  ...
                  <div class="form-wrap">
                    ...
                    <input type="hidden" class="form-control" id="kode_pengajaran" value="<?php echo $auto_kode_pengajaran; ?>" name="kode_pengajaran">
                      ...
                      <div class="col-sm-9">
                        ...
                        <select class="form-control select2 selectpicker" data-style="form-control btn-default btn-outline" name="kode_dosen" id="kode_dosen">
                          ...
                          <?php foreach ($dosen as $row) {?>
                            ...
                            <option value="<?php echo $row['kode_dosen']; ?>"><?php echo $row['nama_dosen']; ?></option>
                      ...
                      <div class="col-sm-9">
                        ...
                        <select class="form-control select2 selectpicker" data-style="form-control btn-default btn-outline" name="kode_matkul" id="kode_matkul">
                          ...
                          <?php foreach ($matkul as $row) {?>
                            ...
                            <option value="<?php echo $row['kode_matkul']; ?>"><?php echo $row['matkul_panjang']; ?></option>
